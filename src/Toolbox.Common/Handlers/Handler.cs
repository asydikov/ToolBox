...
namespace Toolbox.Common.Handlers
{
    public class Handler : IHandler
    {
        ...
        private Func<ToolBoxException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<ToolBoxException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (ToolBoxException customException)
            {
                isFailure = true;
