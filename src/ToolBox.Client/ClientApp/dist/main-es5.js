...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcApp_directivesClickStopPropagationTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ClickStopPropagation", function () {
    ...
    var ClickStopPropagation =
    /*#__PURE__*/
    function () {
      function ClickStopPropagation() {
        _classCallCheck(this, ClickStopPropagation);
      }

      _createClass(ClickStopPropagation, [{
        key: "onClick",
        value: function onClick(event) {//     event.stopPropagation();
    ...
    ClickStopPropagation.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ClickStopPropagation, [{
  ...
  function srcApp_helpersAuthGuardTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_identity_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function AuthGuard(router, identityService) {
      ...
      _createClass(AuthGuard, [{
        ...
        value: function canActivate(route, state) {
          var currentUser = this.identityService.currentUserValue;
    ...
    AuthGuard.ɵfac = function AuthGuard_Factory(t) {
      return new (t || AuthGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_services_identity_service__WEBPACK_IMPORTED_MODULE_2__["IdentityService"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthGuard, [{
        ...
        return [{
          ...
          type: _services_identity_service__WEBPACK_IMPORTED_MODULE_2__["IdentityService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcApp_helpersErrorInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_identity_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../_services/identity.service */
    "./src/app/_services/identity.service.ts");
    ...
    /*#__PURE__*/
    function () {
      function ErrorInterceptor(identityService) {
    ...
    ErrorInterceptor.ɵfac = function ErrorInterceptor_Factory(t) {
      return new (t || ErrorInterceptor)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_services_identity_service__WEBPACK_IMPORTED_MODULE_3__["IdentityService"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ErrorInterceptor, [{
        ...
        return [{
          type: _services_identity_service__WEBPACK_IMPORTED_MODULE_3__["IdentityService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcApp_helpersJwtInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function JwtInterceptor(identityService) {
      ...
      _createClass(JwtInterceptor, [{
        ...
        value: function intercept(request, next) {
          ...
          var currentUser = this.identityService.currentUserValue;
          var isLoggedIn = currentUser && this.identityService.accesTokenFromLocalStorage;
          var isApiUrl = request.url.startsWith(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl);

          if (isLoggedIn && isApiUrl) {
            request = request.clone({
              setHeaders: {
                Authorization: "Bearer ".concat(this.identityService.accesTokenFromLocalStorage)
              }
            });
          }
    ...
    JwtInterceptor.ɵfac = function JwtInterceptor_Factory(t) {
      return new (t || JwtInterceptor)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_services_identity_service__WEBPACK_IMPORTED_MODULE_2__["IdentityService"]));
    };
  ...
  /***/
  function srcApp_modelsRefreshTokenTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RefreshToken", function () {
      return RefreshToken;
    });
  ...
  /***/
  function srcApp_modelsSignInTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcApp_servicesIdentityServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _models_sign_in__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../_models/sign-in */
    "./src/app/_models/sign-in.ts");
    /* harmony import */
    ...
    var _models_refresh_token__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../_models/refresh-token */
    "./src/app/_models/refresh-token.ts");
    /* harmony import */
    ...
    function () {
      ...
      _createClass(IdentityService, [{
        ...
        value: function signIn(email, password) {
          ...
          var signInModel = new _models_sign_in__WEBPACK_IMPORTED_MODULE_3__["SignIn"](email, password);
          return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/").concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].identityService, "/sign-in"), signInModel).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (token) {
            // login successful if there's a jwt token in the response
            if (token && token.accessToken) {
              // store user details and jwt token in local storage to keep user logged in between page refreshes
              localStorage.setItem('userToken', JSON.stringify(token));

              _this2.currentUserSubject.next(new _models_User__WEBPACK_IMPORTED_MODULE_4__["User"](token.claims.email, token.claims.name));
            } else {
              token = null;
            }
        ...
        value: function refreshToken() {
          ...
          var refreshToken = new _models_refresh_token__WEBPACK_IMPORTED_MODULE_6__["RefreshToken"](this.refreshTokenFromLocalStorage);
          return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl, "/").concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].identityService, "/token-refresh"), refreshToken).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (token) {
            if (token && token.accessToken) {
              // store user details and jwt token in local storage to keep user logged in between page refreshes
              localStorage.setItem('userToken', JSON.stringify(token));

              _this3.currentUserSubject.next(new _models_User__WEBPACK_IMPORTED_MODULE_4__["User"](token.claims.email, token.claims.name));
            } else {
              token = null;
            }
        ...
        key: "accesTokenFromLocalStorage",
        get: function get() {
          var _a;

          var userToken = this.userTokenFromLocalStorage;
          var token = (_a = userToken) === null || _a === void 0 ? void 0 : _a.accessToken;
        ...
        key: "refreshTokenFromLocalStorage",
        get: function get() {
          var _a;
        ...
        key: "userFromLocalStorage",
        get: function get() {
          var _a, _b, _c, _d;

          var userToken = this.userTokenFromLocalStorage;
          var userName = (_b = (_a = userToken) === null || _a === void 0 ? void 0 : _a.claims.name, _b !== null && _b !== void 0 ? _b : '');
          var userEmail = (_d = (_c = userToken) === null || _c === void 0 ? void 0 : _c.claims.email, _d !== null && _d !== void 0 ? _d : '');
    ...
    IdentityService.ɵfac = function IdentityService_Factory(t) {
      return new (t || IdentityService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"]));
    };
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        /*! import() | sql-monitor-sql-monitor-module */
        "sql-monitor-sql-monitor-module").then(__webpack_require__.bind(null,
        /*! ./sql-monitor/sql-monitor.module */
        "./src/app/sql-monitor/sql-monitor.module.ts")).then(function (m) {
          return m.SqlMonitorModule;
        });
      },
      data: {
        title: 'Dashboard'
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_identity_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./_services/identity.service */
    "./src/app/_services/identity.service.ts");
    /* harmony import */
    ...
    var _horizontal_nav_horizontal_nav_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./horizontal-nav/horizontal-nav.component */
    ...
    function AppComponent_app_horizontal_nav_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var AppComponent = function AppComponent(identityService) {
      var _this4 = this;

      _classCallCheck(this, AppComponent);

      this.identityService = identityService;
      this.identityService.currentUser.subscribe(function (user) {
        return _this4.currentUser = user;
      });
    };

    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_identity_service__WEBPACK_IMPORTED_MODULE_1__["IdentityService"]));
    };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 6,
      vars: 6,
      consts: [[1, "row", "app-row"], ["class", "col-lg-2 horizontal-nav-container", 4, "ngIf"], [1, "body-container", 3, "ngClass"], [4, "ngIf"], [1, "router-outlet-container"], [1, "col-lg-2", "horizontal-nav-container"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
        ...
        return [{
          type: _services_identity_service__WEBPACK_IMPORTED_MODULE_1__["IdentityService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _horizontal_nav_horizontal_nav_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./horizontal-nav/horizontal-nav.component */
    "./src/app/horizontal-nav/horizontal-nav.component.ts");
    /* harmony import */


    var _directives_click_stop_propagation__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./_directives/click-stop-propagation */
    "./src/app/_directives/click-stop-propagation.ts");
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_6__["LoginComponent"], _nav_nav_component__WEBPACK_IMPORTED_MODULE_7__["NavComponent"], _horizontal_nav_horizontal_nav_component__WEBPACK_IMPORTED_MODULE_10__["HorizontalNavComponent"], _directives_click_stop_propagation__WEBPACK_IMPORTED_MODULE_11__["ClickStopPropagation"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppHorizontalNavHorizontalNavComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HorizontalNavComponent", function () {
    ...
    var HorizontalNavComponent =
    /*#__PURE__*/
    function () {
      function HorizontalNavComponent(router, activatedRoute, identityService) {
        var _this5 = this;

        _classCallCheck(this, HorizontalNavComponent);
      ...
      _createClass(HorizontalNavComponent, [{
        key: "ngOnInit",
    ...
    HorizontalNavComponent.ɵfac = function HorizontalNavComponent_Factory(t) {
      return new (t || HorizontalNavComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_identity_service__WEBPACK_IMPORTED_MODULE_3__["IdentityService"]));
    };

    HorizontalNavComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: HorizontalNavComponent,
      selectors: [["app-horizontal-nav"]],
      decls: 9,
      vars: 2,
      consts: [["role", "alert", 1, "alert", "alert-dark", "horizontal-nav", 2, "background-color", "black", "opacity", "0.85", "border", "0px", "color", "white"], [1, "row", "justify-content-between"], [1, "ml-4"], [1, "d-flex", "align-items-center"], [1, "mr-4", 2, "font-size", "19px"], [2, "font-weight", "bold"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HorizontalNavComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LoginComponent(formBuilder, router, identityService) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.loading = true;
          this.identityService.signIn(this.form.email.value, this.form.password.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function (data) {
  ...
  function srcAppNavNavComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function NavComponent_nav_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NavComponent_nav_0_Template_a_click_17_listener() {
    ...
    /*#__PURE__*/
    function () {
      function NavComponent(router, identityService) {
        var _this8 = this;
    ...
    NavComponent.ɵfac = function NavComponent_Factory(t) {
      return new (t || NavComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_identity_service__WEBPACK_IMPORTED_MODULE_2__["IdentityService"]));
    };
    ...
    NavComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["id", "sidebar", 4, "ngIf"], ["id", "sidebar"], [1, "img", "bg-wrap", "text-center", "py-4"], [1, "user-logo"], [1, "fa", "fa-database", "fa-5x", "mb-3", 2, "color", "red"], [1, "text-monospace", 2, "color", "white"], [1, "list-unstyled", "components", "mb-5"], [1, "active"], [3, "routerLink"], [1, "fa", "fa-home", "mr-3"], [1, "fa", "fa-server", "mr-3", "notif"], [3, "routerLink", "click"], [1, "fa", "fa-sign-out", "mr-3"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\MyData\Projects\ToolBox\server\ToolBox.Client\ClientApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
